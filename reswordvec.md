...
The 1911-922 period does see a lot more discussion of public health commissions and health inspectors in the pages of the journal. However, I believe much of the change in associated words is also reflective of a change in the structure of the miscellaneous news sections of the journal which becomes less filled with poetry, anecdotes, and reports of strange accidents. The June 1909 issue announced that *Stone* was making some changes to its form "in response to suggestions from the leading producers and workers of stone." (27) The "Quarrying" section (formerly "Notes from Quarry and Shop") changed its name to "Notes from the Stone Fields," and became much more business-focused, with small news articles divided into different sections within the stone industry. The word with the greatest association to "health" in the 1911-1922 corpus is "mutual." When I ran "mutual" through the keyword in context analysis the word appeared most often in the context of mutual life insurance buildings. Mutual life insurance buildings appear in the text in four places: in brief notes in "Notes from the Stone Fields"; in photo captions of stone-clad life insurance buildings spread out within miscellaneous sections; in the "Construction Notes" (formerly "Contract News") section; and in advertisements that list completed projects that used a particular stone. Many of the unusual words at the left-hand side of the graph such as "essex" and "perkins" also appear primarily in these miscellaneous sections and advertisements in architecture firm names and in the names of buildings that used or were considering using stone.
...
I'd be interested in experimenting more with word embeddings -- I'd like to look more closely at some of the associations between safety and gender I was seeing in the early safety articles. I have seen other projects where the researcher has assigned negative and positive values to words and think that would be a good next step for this project, but would need to move to other tools for this work. I worry the rarity of my words might make those investigations as unsuccessful as they were when I tried to do comparisons within this analysis technique. I do think this is a useful technique, but only when combined with keyword in context searches to see how these connections are being made.
...
[2] Image Source: [*Stone: An Illustrated Magazine* 38 (April 1914)](https://babel.hathitrust.org/cgi/pt?id=nyp.33433069065914&view=1up&seq=8), 213.